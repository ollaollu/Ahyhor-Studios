...
Refinery::Core.configure do |config|
  ...
  config.s3_access_key_id = ENV['CONFIG.S3_ACCESS_KEY_ID']
  config.s3_secret_access_key = ENV['CONFIG.S3_SECRET_ACCESS_KEY']
  config.s3_bucket_name = ENV['CONFIG.S3_BUCKET_NAME']
  config.s3_region = ENV['CONFIG.S3_REGION']
  ...
  # Site name
  config.site_name = "AhyhorStudios"
  ...
  # config.dragonfly_secret = "37df0b60c1e8fb2b762f28f25debd6f5ebb9b86c69ef59c6"
